...
#[wasm_bindgen(js_name = vec4_create)]
pub fn create() -> Float32Array {
    return Float32Array::new_with_length(4);
}

#[wasm_bindgen(js_name = vec4_clone)]
...
#[wasm_bindgen(js_name = vec4_fromValues)]
...
#[wasm_bindgen(js_name = vec4_copy)]
...
#[wasm_bindgen(js_name = vec4_subtract)]
...
#[wasm_bindgen(js_name = vec4_multiply)]
...
#[wasm_bindgen(js_name = vec4_divide)]
...
#[wasm_bindgen(js_name = vec4_ceil)]
...
#[wasm_bindgen(js_name = vec4_floor)]
...
#[wasm_bindgen(js_name = vec4_round)]
...
#[wasm_bindgen(js_name = vec4_scale)]
...
#[wasm_bindgen(js_name = vec4_scaleAndAdd)]
...
#[wasm_bindgen(js_name = vec4_distance)]
...
#[wasm_bindgen(js_name = vec4_squaredDistance)]
...
#[wasm_bindgen(js_name = vec4_length)]
...
#[wasm_bindgen(js_name = vec4_squaredLength)]
...
#[wasm_bindgen(js_name = vec4_negate)]
...
#[wasm_bindgen(js_name = vec4_inverse)]
...
#[wasm_bindgen(js_name = vec4_normalize)]
...
#[wasm_bindgen(js_name = vec4_cross)]
pub fn cross(
    out: Float32Array,
    u: &Float32Array,
    v: &Float32Array,
...
#[wasm_bindgen(js_name = vec4_lerp)]
...
#[wasm_bindgen(js_name = vec4_random)]
...
#[wasm_bindgen(js_name = vec4_transformMat4)]
...
#[wasm_bindgen(js_name = vec4_transformQuat)]
pub fn transform_quat(out: Float32Array, a: &Float32Array, q: &Float32Array) -> Float32Array {
    ...
    out.set_index(
        0,
        ix * q.get_index(3) + iw * -q.get_index(0) + iy * -q.get_index(2) - iz * -q.get_index(1),
    );
    out.set_index(
        1,
        iy * q.get_index(3) + iw * -q.get_index(1) + iz * -q.get_index(0) - ix * -q.get_index(2),
    );
    out.set_index(
        2,
        iz * q.get_index(3) + iw * -q.get_index(2) + ix * -q.get_index(1) - iy * -q.get_index(0),
    );
    out.set_index(3, a.get_index(3));
    return out;
}

#[wasm_bindgen(js_name = vec4_zero)]
...
#[wasm_bindgen(js_name = vec4_exactEquals)]
...
#[wasm_bindgen(js_name = vec4_equals)]
