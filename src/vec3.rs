...
#[wasm_bindgen(js_name = vec3_create)]
pub fn create() -> Float32Array {
    return Float32Array::new_with_length(3);
}

#[wasm_bindgen(js_name = vec3_clone)]
...
#[wasm_bindgen(js_name = vec3_fromValues)]
...
#[wasm_bindgen(js_name = vec3_copy)]
...
#[wasm_bindgen(js_name = vec3_subtract)]
...
#[wasm_bindgen(js_name = vec3_multiply)]
...
#[wasm_bindgen(js_name = vec3_divide)]
...
#[wasm_bindgen(js_name = vec3_ceil)]
...
#[wasm_bindgen(js_name = vec3_floor)]
...
#[wasm_bindgen(js_name = vec3_round)]
...
#[wasm_bindgen(js_name = vec3_scale)]
...
#[wasm_bindgen(js_name = vec3_scaleAndAdd)]
...
#[wasm_bindgen(js_name = vec3_distance)]
...
#[wasm_bindgen(js_name = vec3_squaredDistance)]
...
#[wasm_bindgen(js_name = vec3_inverse)]
...
#[wasm_bindgen(js_name = vec3_normalize)]
...
#[wasm_bindgen(js_name = vec3_cross)]
...
#[wasm_bindgen(js_name = vec3_lerp)]
...
#[wasm_bindgen(js_name = vec3_hermite)]
pub fn hermit(
    out: Float32Array,
    a: &Float32Array,
    b: &Float32Array,
...
#[wasm_bindgen(js_name = vec3_bezier)]
pub fn bezier(
    out: Float32Array,
    a: &Float32Array,
    b: &Float32Array,
...
#[wasm_bindgen(js_name = vec3_random)]
...
#[wasm_bindgen(js_name = vec3_transformMat4)]
...
#[wasm_bindgen(js_name = vec3_transformMat3)]
...
#[wasm_bindgen(js_name = vec3_transformQuat)]
...
#[wasm_bindgen(js_name = vec3_rotate_x)]
pub fn rotate_x(out: Float32Array, a: &Float32Array, b: &Float32Array, rad: f32) -> Float32Array {
    let p = subtract(Float32Array::new_with_length(3), a, b);
    let r = from_values(
        p.get_index(0),
...
#[wasm_bindgen(js_name = vec3_rotate_y)]
pub fn rotate_y(out: Float32Array, a: &Float32Array, b: &Float32Array, rad: f32) -> Float32Array {
    let p = subtract(Float32Array::new_with_length(3), a, b);
    let r = from_values(
...
#[wasm_bindgen(js_name = vec3_rotate_z)]
pub fn rotate_z(out: Float32Array, a: &Float32Array, b: &Float32Array, rad: f32) -> Float32Array {
    let p = subtract(Float32Array::new_with_length(3), a, b);
    let r = from_values(
...
#[wasm_bindgen(js_name = vec3_zero)]
...
#[wasm_bindgen(js_name = vec3_exactEquals)]
...
#[wasm_bindgen(js_name = vec3_equals)]
